describe("Pik", function () {
  it("Gets, types and visual tests", function () {
    ...
    cy.contains("Details").click().wait(2000);

    //Opens channels section
    cy.contains("The basic channels").click().wait(2000);

    //Opens FAQ section
    cy.contains("Frequently Asked Questions").click().wait(3000);
    ...
    //Opens channels section
    cy.contains("The basic channels").click().wait(3000);
