describe('Optik Plans PDP', function() {
  it('Gets, types and visual tests', function() {
    cy.visitHSCHomepage()//Visit base url then qual compass
      ...
      .fillCompassAddress() 
    cy.visitHSCHomepage()
      .visit('/shop/home/product/essentials-mediaroomtv-hs2-0')//visit Optik Essentials 2yr PDP Plans
    ...
    cy.visit('/shop/home/product/4-theme-packs-1-premium-mediaroomtv-hs2-0?variant=f5172855730be3ee2355fa783d37589f')//visit Optik 4TP+1 Noterm PDP
      .setCookie('QSI_SI_8II6mHwhblM7icZ_intercept','true' )//sets cookie so purple banner does not apppear 
      .wait(3000)
    cy.window().contains('View terms and conditions').click()//Opens T & C section
      .wait(2000)
