describe('Test Top 5 Prepopulators', function() {
   ...
   describe('Smoke test FIFA flow HSC e2e', function() {
     it('Verify Free TV Prepop', function () {
      cy.visit('/shop/home-services/loading?o[internet-75-75|internet-75|internet-50]&p[4-theme-packs-1-premium-mediaroomtv-hs2-0]&c[optikTVCount]=2&p[free-samsung-55-tv]&r=/en/commerce/cart',{ timeout: 60000 })
